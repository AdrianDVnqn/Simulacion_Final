...
```{r posterior-analitica, fig.cap="Figura 2.1.1: Posterior analítica Beta(8,4)."}
...
```{r mh-traceplot, fig.cap="Figura 2.2.1: Traceplot de la cadena MH (con burn-in indicado en línea roja)."}
...
```{r mh-acf, fig.cap="Figura 2.2.2: Autocorrelación de la cadena post burn-in."}
...
```{r mh-hist, fig.cap="Figura 2.2.3: Histograma MH vs posterior analítica Beta(8,4) (línea roja punteada)."}
